          ...
          if(Number.isInteger(tempnum)){  
            ...
            try{
              if(pet){
                ...
                var e = name
                if(playerstorage.items.food && playerstorage.items.food >= tempnum){
                  if(q[e].food >= 100) return await message.channel.send("Your pet is already fed!")
                  if(q[e].sit){
                  ...
                  q[e].food += 20 * tempnum
                  if(q[e].food >= 160) return await message.channel.send("Don't over-feed your pet!")
                  ...
                  return await message.channel.send(`Successfully gave ${name.charAt(0).toUpperCase() + name.slice(1)} food.`)
                }else{
                  return await message.channel.send(`You don't have enough food.`)
                }
              }
            }catch(err){
            ...
            try{
              if(pet){
                ...
                let e = name
                if(playerstorage.items.food && playerstorage.items.food >= num){
                  if(q[e].food >= 100) return await message.channel.send("Your pet is already fed!")
                  if(q[e].sit){
                    return await message.channel.send("Your pet is with the sitter!")
                  }
